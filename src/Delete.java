...
public class Delete extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int id=Integer.parseInt(tDelete.getText());
       try {
            ...
            if(rs>0){
                ...
                try {
                    PreparedStatement ps=cn.prepareStatement("set @num:=0;");
                    ps.executeUpdate();
                            PreparedStatement pst=cn.prepareStatement("update student set id=@num:=(@num+1)");
                            pst.executeUpdate();
                                    PreparedStatement psm=cn.prepareStatement("Alter table student AUTO_INCREMENT=1");
                                    psm.executeUpdate();
                ...
                JOptionPane.showMessageDialog(Delete.this, "Deleted");

                this.dispose();

            }
            else{
                JOptionPane.showMessageDialog(Delete.this, "Error");
            }
